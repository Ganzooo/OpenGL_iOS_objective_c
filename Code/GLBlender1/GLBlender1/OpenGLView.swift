...
class OpenGLView: UIView {
    ...
    func compileShader(_ shaderName: String, shaderType: GLenum, shader: UnsafeMutablePointer<GLuint>) -> Int {
    ...
    func compileShaders() -> Int {
        ...
        //_floorTexture = self.setupTexture("dog.png");
        //_fishTexture = self.setupTexture("item_powerup_fish.png");
        _fishTexture = self.setupTexture("dog.png");
    ...
    //func render(_ displayLink: CADisplayLink) -> Int {
    //gz change
    func render(displayLink: CADisplayLink) -> Int {
        ...
        let vertexSlotFirstComponent = UnsafePointer<Int>(bitPattern: MemoryLayout<GLfloat>.size * 7)
        glVertexAttribPointer(_texCoordSlot, 2, GLenum(GL_FLOAT), GLboolean(GL_FALSE),
                              GLsizei(MemoryLayout<Vertex>.size), vertexSlotFirstComponent);
        ...
        glVertexAttribPointer(_positionSlot, 3, GLenum(GL_FLOAT), GLboolean(GL_FALSE), GLsizei(MemoryLayout<Vertex>.size), positionSlotFirstComponent);
        glVertexAttribPointer(_colorSlot, 4, GLenum(GL_FLOAT), GLboolean(GL_FALSE), GLsizei(MemoryLayout<Vertex>.size), colorSlotFirstComponent);
        glVertexAttribPointer(_texCoordSlot, 2, GLenum(GL_FLOAT), GLboolean(GL_FALSE), GLsizei(MemoryLayout<Vertex>.size), vertexSlotFirstComponent);
        
        glDrawElements(GLenum(GL_TRIANGLE_STRIP), GLsizei((_indices2.count * MemoryLayout<GLubyte>.size)/MemoryLayout<GLubyte>.size), GLenum(GL_UNSIGNED_BYTE), positionSlotFirstComponent);
    ...
    func setupTexture(_ fileName: String) -> GLuint{
    ...
    func setupVBOs() -> Int {
        ...
        glBindBuffer(GLenum(GL_ARRAY_BUFFER), _vertexBuffer2)
        glBufferData(GLenum(GL_ARRAY_BUFFER), (_vertices2.count * MemoryLayout<Vertex>.size), _vertices2, GLenum(GL_STATIC_DRAW))
        
        glGenBuffers(1, &_indexBuffer2)
        glBindBuffer(GLenum(GL_ELEMENT_ARRAY_BUFFER), _indexBuffer2)
        glBufferData(GLenum(GL_ELEMENT_ARRAY_BUFFER), (_indices2.count * MemoryLayout<GLubyte>.size), _indices2, GLenum(GL_STATIC_DRAW))
